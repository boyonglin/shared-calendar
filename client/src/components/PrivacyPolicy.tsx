...
export function PrivacyPolicy() {
  return (
    <div className="h-screen bg-gray-50 dark:bg-gray-900 flex flex-col items-center py-[8vh]">
      <div className="w-full max-w-3xl flex-1 flex flex-col min-h-0">
        ...
        <ScrollArea className="flex-1 px-12 py-6">
          <div className="space-y-6 text-gray-700 dark:text-gray-300">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                in this Agreement) refers to Shared Calendar Vibe.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Shared Calendar Vibe,
                accessible from{" "}
                <a
                  href="https://shared-calendar-vibe.vercel.app/"
                  rel="external nofollow noopener noreferrer"
                  target="_blank"
                  className="text-blue-600 dark:text-blue-400 hover:underline"
                >
                  https://shared-calendar-vibe.vercel.app/
                </a>
              </li>
              <li>
            ...
            <ul className="list-disc pl-6">
              <li>
                By email:{" "}
                <a
                  href="mailto:poerevan9@gmail.com"
                  className="text-blue-600 dark:text-blue-400 hover:underline"
                >
                  poerevan9@gmail.com
                </a>
